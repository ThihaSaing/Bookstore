                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="../images/HD-books-wallpaper-backgrounds.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/201553321334-book-library-magic-ship-adventure-tree.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/346199.jpg" alt="">
                                </div>
                            </div>
