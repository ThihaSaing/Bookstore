...
<form action="../controller/Publisher.php" class="form-inline" method="POST">
	<div class="form-group">
		<label name="pubname" class="control-label">Publisher name</label>
		<input type="text" name="pubname" class="form-control"required>
	</div>
	<input type="submit" name="insert" value="Add" class="btn btn-default btn-primary">
</form>
</div>
<?php require_once "publisher_view.php"; ?>
</div>
